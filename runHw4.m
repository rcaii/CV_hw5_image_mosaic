...
signAcademicHonestyPolicy('Weijie Cai', 'wc2756');
...
ransac_eps = 2.0; %Acceptable alignment error 
...
% Your own panorama
imgl = im2single(imread('street_left.png'));
imgc = im2single(imread('street_center.png'));
imgr = im2single(imread('street_right.png'));

imgl = imresize(imgl, 0.5);
imgc = imresize(imgc, 0.5);
